...
import com.example.workit.Adapters.DeviceListAdapter;
import com.example.workit.R;
import com.example.workit.Utilities.BluetoothConnectionService;
...
public class MainActivity extends AppCompatActivity
        ...
        HomeViewFragment.CityDataPassListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Bluetooth buttons
        Button btnONOFF = findViewById(R.id.ble_button);
...
//        });
    ...
    @Override
    public void passCityData(String cityData) {
        Map_view_fragment map_view_fragment = new Map_view_fragment();
        Bundle args = new Bundle();
        args.putString(Map_view_fragment.DATA_RECEIVE, cityData);
    ...
    //***the connection will fail and app will crash if devices haven't paired first
    ...
    public void enableDisableBT() {
        ...
        if (!mBluetoothAdapter.isEnabled()) {
            //implements a broadcast/receiver
